...
const DrumComponent = () => {
  ...
  return (
    <div className="drum-machine w-1/2 mx-auto bg-blue bg-white p-8 rounded shadow-md text-center">
      ...
      <div className="grid grid-cols-3 gap-4">
        <button className="drum-pad bg-yellow-500 text-white px-4 py-2 rounded-full" onClick={() => reproducir("Q")}>Q</button>
        <button className="drum-pad bg-yellow-500 text-white px-4 py-2 rounded-full" onClick={() => reproducir("W")}>W</button>
        <button className="drum-pad bg-yellow-500 text-white px-4 py-2 rounded-full" onClick={() => reproducir("E")}>E</button>
        <button className="drum-pad bg-yellow-500 text-white px-4 py-2 rounded-full" onClick={() => reproducir("A")}>A</button>
        <button className="drum-pad bg-yellow-500 text-white px-4 py-2 rounded-full" onClick={() => reproducir("S")}>S</button>
        <button className="drum-pad bg-yellow-500 text-white px-4 py-2 rounded-full" onClick={() => reproducir("D")}>D</button>
        <button className="drum-pad bg-yellow-500 text-white px-4 py-2 rounded-full" onClick={() => reproducir("Z")}>Z</button>
        <button className="drum-pad bg-yellow-500 text-white px-4 py-2 rounded-full" onClick={() => reproducir("X")}>X</button>
        <button className="drum-pad bg-yellow-500 text-white px-4 py-2 rounded-full" onClick={() => reproducir("C")}>C</button>
      </div>
